...
export function ChangePasswordForm() {
  ...
  return (
    <Card className="w-full relative max-w-lg">
      <div className="flex absolute justify-center left-0 -top-44 items-center w-full">
        <div className="p-5 bg-card rounded-full shadow-lg">
          <IconLockPassword width={100} height={100} className="text-primary" />
        </div>
      </div>
